...
final class Pair
{
    ...
    private const SHOULD_USE_TUPLE_MSG =
      "An array with 2 values can not be used with this method. Did you mean to use " . self::class . "::fromTuple?";

    private const SHOULD_USE_ARRAY_MSG =
      "A single key-value array can not be used with this method. Did you mean to use " . self::class . "::fromArray?";

    private const TOO_MANY_VALUES_MSG = "Too many values in the provided array.";

    public function __construct(
        private string|int|bool|float|null|object $key,
        private string|int|bool|float|null|object $value
    ) {
    }
